...
class SimAnneal(object):
    def __init__(self, distance_matrix, initial_solution, T=-1, alpha=-1, stopping_T=-1, stopping_iter=-1):
        self.distance_matrix = distance_matrix
        self.cur_solution = initial_solution
        self.cur_fitness = self.fitness(initial_solution)
    ...
    def fitness(self, route):
        ...
        prev = route[0]
        for node in route[1:]:
            dist += self.distance_matrix[prev, node]
            prev = node
        return dist
